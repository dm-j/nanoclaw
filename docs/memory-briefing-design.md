...
## 7a. Delivery mechanism insight: `isSynthetic` / `shouldQuery` (found 2026-07-11)
...
- Whether briefing delivery uses `isSynthetic`/`shouldQuery` synthetic messages (§7a) or plain prompt concatenation, and whether that lets session-resume be skipped entirely.
